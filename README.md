...
1.现在自动生成的config.yml文件可以修改每页显示的图片数量了。详情见[使用方法下的第九条](https://github.com/LhyYBMQ520/My-Image-Gallery/edit/main/README.md#%E5%A6%82%E4%BD%95%E4%BD%BF%E7%94%A8)
