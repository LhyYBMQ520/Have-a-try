...
本分支的后端专为Windows端做了兼容并暂时不合并进main分支中。

## 仍有不足

1.网页布局仍存在问题，正在和合作者商量下一步改进相关的事。

2.目前Waitress无法在控制台输出远程访问请求的ip和图片获取之类的详细日志，尝试攻克的过程中被各种问题和报错打败了。

开发者--L菌：我觉得不如Gunicorn），你们都给我去用Linux！
